package com.is.authservice.repository;

import com.is.authservice.model.sports.SkillsDTO;
import com.is.authservice.model.sports.Sport_skills;
...
public interface ListOfSkillsRepository extends JpaRepository<Sport_skills, Long> {
    ...
    @Query("SELECT new com.is.authservice.model.sports.SkillsDTO(s.id,s.min_value,s.max_value," +
